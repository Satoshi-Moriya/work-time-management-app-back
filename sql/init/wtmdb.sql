...
DROP TABLE IF EXISTS record_item_logs;

CREATE TABLE IF NOT EXISTS record_item_logs
(
  record_item_log_id            INT NOT NULL AUTO_INCREMENT,
  record_item_id                INT NOT NULL,
  record_item_log_date          DATE NOT NULL,
  record_item_log_start_time    DATETIME NOT NULL,
  record_item_log_end_time      DATETIME NOT NULL,
  record_item_log_seconds       MEDIUMINT NOT NULL,
  PRIMARY KEY (record_item_log_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO record_item_logs
  (record_item_log_id, record_item_id, record_item_log_date, record_item_log_start_time, record_item_log_end_time, record_item_log_seconds)
VALUES
